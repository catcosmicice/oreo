...
export class Oreo extends AkairoClient {
    ...
    constructor() {
        ...
        this.handler = new CommandHandler(this, {
            directory: __dirname.includes('/dist/') ? './dist/src/commands/' : './src/commands',
            commandUtil: true,
            handleEdits: true,
        ...
        this.listener = new ListenerHandler(this, {
            directory: __dirname.includes('/dist/') ? './dist/src/listeners/' : './src/listeners'
        });

        this.inhibitor = new InhibitorHandler(this, {
            directory: __dirname.includes('/dist/') ? './dist/src/inhibitors/' : './src/inhibitors',
        });
