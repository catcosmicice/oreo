                                    ...
                                    (r = e[i]) &&
                                        (s =
                                            (a < 3
                                                ...
                                                : r(t, n)) || s);
                            return (
                                a > 3 && s && Object.defineProperty(t, n, s), s
                            );
                        }
                        ...
                        class l extends r.BaseCommand {
                            ...
                            async execute() {
                                ...
                                if (this.all) s = new Set(t.workspaces);
                                    ...
                                    if (!n)
                                        throw new r.WorkspaceRequiredError(
                                            t.cwd,
                                            this.context.cwd
                                        );
                                    s = new Set([n]);
                                    ...
                                    s = new Set(
                                        this.workspaces.map((e) =>
                                            t.getWorkspaceByIdent(
                                                a.structUtils.parseIdent(e)
                                            )
                                        )
                                    );
                                for (const e of s)
                                    for (const n of a.Manifest.hardDependencies)
                                        for (const o of e.manifest
                                            .getForScope(n)
                                            .values()) {
                                            const e = t.tryWorkspaceByDescriptor(
                                                o
                                            );
                                            null !== e && s.add(e);
                                        }
                                ...
                                const n = new Set(),
                                    o = (e) => {
                                        ...
                                        for (const e of r.values()) {
                                            const r = t.tryWorkspaceByDescriptor(
                                                e
                                            );
                                            null === r ||
                                                n.has(r) ||
                                    ...
                                    async (e) => {
                                        const o = async (
                                            ...
                                            const r = (function (
                                                    ...
                                                    if (!o) return null;
                                                    const r = a.structUtils.convertToIdent(
                                                            e.locator
                                                        ),
                                                        s = `[${a.structUtils.stringifyIdent(
                                                            r
                                                        )}]:`,
                                                        i = [
                                                            "#2E86AB",
                                            ...
                                            for (const [e, t] of _) {
                                                ...
                                                if (
                                                    ...
                                                    for (const t of e.values()) {
                                                        const e = n.tryWorkspaceByDescriptor(
                                                            t
                                                        );
                                                        if (
                                                            ((a =
                        ...
                        e.exports = (e, t = {}) => {
                            let n = (e, a = {}) => {
                                ...
                                if (e.nodes && e.ranges > 0) {
                                    ...
                                    if (0 !== a.length)
                                        return n.length > 1 && a.length > 1
                                            ? `(${a})`
                                            : a;
                                }
                                if (e.nodes)
                                    for (let t of e.nodes) p += n(t, e);
                                return p;
                            };
                            return n(e);
                        };
                    ...
                    169: (e, t, n) => {
                        ...
                        const o = n(669),
                            ...
                            g = (e, t, n = 1, o = {}) => {
                                ...
                                let A = l(i) || l(h) || l(g),
                                    y = A
                                        ? Math.max(i.length, h.length, g.length)
                                        : 0,
                                    R =
                                        !1 === A &&
                                        !1 ===
                    ...
                    401: (e, t, n) => {
                        ...
                        (l.match = l),
                            ...
                            (l.contains = (e, t, n) => {
                                ...
                                if (Array.isArray(t))
                                    return t.some((t) => l.contains(e, t, n));
                                if ("string" == typeof t) {
                                    if (i(e) || i(t)) return !1;
                                    if (
                                        e.includes(t) ||
                                        (e.startsWith("./") &&
                                            e.slice(2).includes(t))
                                    )
                                        return !0;
                                }
                        ...
                        const o = n(86),
                            ...
                            d = (e, t) => {
                                ...
                                for (; B.brackets > 0; ) {
                                    ...
                                    (B.output = r.escapeLast(B.output, "[")),
                                        Y("brackets");
                                }
                                for (; B.parens > 0; ) {
                                    if (!0 === n.strictBrackets)
                    ...
                    828: (e, t, n) => {
                        ...
                        (l.test = (e, t, n, { glob: o, posix: r } = {}) => {
                            ...
                            (l.matchBase = (e, t, n, r = s.isWindows(n)) =>
                                (t instanceof RegExp ? t : l.makeRe(t, n)).test(
                                    o.basename(e)
                                )),
                        ...
                        const o = n(761),
                            r = (e, t, n) => {
                                ...
                                let l =
                                    ...
                                    String(a.capture) +
                                    String(a.wrap);
                                if (r.cache.hasOwnProperty(l))
                                    return r.cache[l].result;
                                let u = Math.min(e, t),
                                    p = Math.max(e, t);
                                if (1 === Math.abs(u - p)) {
                                    let n = e + "|" + t;
