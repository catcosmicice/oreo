            ...
            var e = {
                    958: (e, t, r) => {
                        ...
                        const d = (e) => {
                                ...
                                return c()(
                                    "OFCNCOG2CU",
                                    "e8e1bd300d860104bb8c58453ffa1eb4",
                                    {
                                        requester: t
                                    }
                                );
                            ...
                            l = (e) =>
                                e.scope ? `${e.scope}__${e.name}` : "" + e.name,
                            u = {
                                hooks: {
                                    afterWorkspaceDependencyAddition: async (
                                        ...
                                        if (
                                            !(await (async (e, t) => {
                                                var r;
                                                const a = s.structUtils.stringifyIdent(
                                                        e
                                                    ),
                                                    o = d(t).initIndex(
                                                        "npm-search"
                                            ...
                                            return;
                                        const m = l(r);
                                        let h = s.structUtils.parseRange(
                                            r.range
                                        ).selector;
                                        if (!n().validRange(h)) {
                                            const e = await u.getCandidates(
                                                r,
                                                new Map(),
                                                p
                                            );
                                            h = s.structUtils.parseRange(
                                                e[0].reference
                                            ).selector;
                                        }
                                        const y = n().coerce(h);
                                        ...
                                        const g = `${a.suggestUtils.Modifier.CARET}${y.major}`,
                                            b = s.structUtils.makeDescriptor(
                                                s.structUtils.makeIdent(
                                                    "types",
                                                    m
                                                ),
                                                g
                                            ),
                                            f = s.miscUtils.mapAndFind(
                                                i.workspaces,
                                                (e) => {
                                                    var t, a;
                                                    const o =
                                                            null ===
                                                                (t = e.manifest.dependencies.get(
                                                                    r.identHash
                                                                )) ||
                                                            void 0 === t
                                                                ? void 0
                                        ...
                                        if (void 0 !== f)
                                            ...
                                            e.manifest[
                                                a.suggestUtils.Target
                                                    .DEVELOPMENT
                                            ].set(b.identHash, b);
                                        }
                                    },
                                    afterWorkspaceDependencyRemoval: async (
                                        e,
                                        t,
                                        r
                                    ) => {
                    ...
                    757: (e, t, r) => {
                        ...
                        function i(e, t) {
                            return (
                                Object.keys(void 0 !== t ? t : {}).forEach(
                                    (r) => {
                                        e[r] = t[r](e);
                                    }
                                ),
                        ...
                        const n = (e) => {
                                const t = e.region || "us",
                                    ...
                                    o = (0, a.createTransporter)({
                                        hosts: [
                                            {
                                                url: `recommendation.${t}.algolia.com`
                                            }
                                        ],
                                        ...e,
                                        headers: {
                    ...
                    790: (e, t, r) => {
                                    ...
                                    hosts: [
                                        {
                                            ...
                                            accept: a.CallEnum.Read
                                        },
                                        {
                                            url: t + ".algolia.net",
                                            accept: a.CallEnum.Write
                                        }
                                    ].concat(
                                        (0, s.shuffle)([
                        ...
                        const p = (e) => (t, r) => {
                            ...
                            w = (e) => (t) =>
                                e.transporter.read(
                                    { method: o.N.Get, path: "1/keys" },
                                    t
                                ),
                            A = (e) => (t) =>
                                e.transporter.read(
                                    { method: o.N.Get, path: "1/clusters" },
                                    t
                                ),
                            q = (e) => (t) =>
                                e.transporter.read(
                                    { method: o.N.Get, path: "1/indexes" },
                                    t
                                ),
                            R = (e) => (t) =>
                                e.transporter.read(
                            ...
                            C = (e) => (t, r) => {
                                const s = t.map((e) => ({
                                    ...e,
                                    params: (0, a.serializeQueryParameters)(
                                        e.params || {}
                                    )
                                }));
                            ...
                            B = (e) => (t) => {
                                ...
                                return i({
                                    ...r,
                                    shouldStop: (e) =>
                                        e.hits.length < r.hitsPerPage,
                                    request: (t) =>
                                        ve(e)("", { ...r, ...t }).then((e) => ({
                                            ...e,
                                            hits: e.hits.map(
                                                (e) => (
                                                    delete e._highlightResult, e
                                                )
                                            )
                                        }))
                                });
                                    ...
                                    c = (s = 0) => {
                                        ...
                                        return 0 === a.length
                                            ...
                                            : H(e)(
                                                  ...
                                                  (e) => (
                                                      (i.objectIDs = i.objectIDs.concat(
                                                          e.objectIDs
                                                      )),
                            ...
                            L = (e) => (t) => {
                                ...
                                return (
                                    r &&
                                        (i.queryParameters.forwardToReplicas = 1),
                                    (0, s.createWaitablePromise)(
                                        e.transporter.write(
                                            {
                                                method: o.N.Post,
                            ...
                            Z = (e) => (t, r) => {
                                ...
                                return (
                                    n &&
                                        (c.queryParameters.forwardToReplicas = 1),
                                    (0, s.createWaitablePromise)(
                                        e.transporter.write(
                                            {
                                                method: o.N.Delete,
                            ...
                            oe = (e) => (t, r) => {
                                const { attributesToRetrieve: s, ...a } =
                                        r || {},
                                    n = t.map((t) => ({
                            ...
                            ge = (e) => (t, r) => {
                                const {
                                        autoGenerateObjectIDIfNotExist: a,
                                        ...o
                                    } = r || {},
                            ...
                            fe = (e) => (t, r) => {
                                ...
                                return (
                                    n &&
                                        (d.queryParameters.forwardToReplicas = 1),
                                    i &&
                                        (d.queryParameters.clearExistingRules = 1),
                                    (0, s.createWaitablePromise)(
                                        e.transporter.write(
                                            {
                                                method: o.N.Post,
                            ...
                            Ie = (e) => (t, r) => {
                                ...
                                return (
                                    n &&
                                        (d.queryParameters.forwardToReplicas = 1),
                                    i &&
                                        (d.queryParameters.replaceExistingSynonyms = 1),
                                    (0, s.createWaitablePromise)(
                                        e.transporter.write(
                                            {
                                                method: o.N.Post,
                    ...
                    487: (e, t, r) => {
                        ...
                        function n() {
                            ...
                            return {
                                ...
                                destroy: () => (
                                    t.destroy(), r.destroy(), Promise.resolve()
                                )
                            };
                        }
                    },
                                    ...
                                    initIndex: (e) => (t) =>
                                        c.initIndex(e)(t, {
                                            methods: {
                                                ...
                                                search: c.search,
                                                searchForFacetValues:
                                                    c.searchForFacetValues,
                                                waitTask: c.waitTask,
                                                setSettings: c.setSettings,
                                                getSettings: c.getSettings,
                                                partialUpdateObject:
                                                    c.partialUpdateObject,
                                                partialUpdateObjects:
                                                    c.partialUpdateObjects,
